...
Then substituting for \(u, \mathrm{d}u/\mathrm{d}x, v\) and \(\mathrm{d}v/\mathrm{d}x\) in equation (4) we get
\begin{align*}
...
&=\left(\frac{-x^2\cos(2x)}{2}\right)+\int x\cos(2x)\mathrm{d}x\tag{5}
\end{align*}
...
\[
\int x\cos(2x)\mathrm{d}x = \left(x\times\frac{\sin(2x)}{2}\right) - \int\frac{\sin(2x)}{2}\times1\mathrm{d}x = \left(\frac{x\sin(2x)}2\right)+\left(\frac{\cos(2x)}4\right)\tag{6}.
\]
