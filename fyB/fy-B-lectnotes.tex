...
For a straight line we can consider the slope or \textcolor{red}{\em gradient}\index{gradient}. This is a measure of how steep the line is

\begin{figure}

{\centering \includegraphics[width=0.2\linewidth]{tikztopng-figure1} 

}

\caption{gradient of a line}\label{fig:unnamed-chunk-4}
\end{figure}
...
Suppose now we are given a curve with equation \(y=f(x)\) and want to find the gradient of a line segment joining two points on the curve.

\begin{figure}

{\centering \includegraphics[width=0.4\linewidth]{tikztopng-figure2} 

}

\caption{line segment on a curve}\label{fig:unnamed-chunk-5}
\end{figure}
...
Two lines are \textcolor{red}{\em parallel}\index{parallel} if their gradients are identical. For example \(y=2x\), \(y=2x-2\) and \(y=2x+3\) all have gradient of \(4\) and hence are all parallel.

\begin{figure}

{\centering \includegraphics[width=0.3\linewidth]{tikztopng-figure3} 

}

\caption{parallel lines}\label{fig:unnamed-chunk-12}
\end{figure}
\slide

If two lines are perpendicular we may also find a relationship between their gradients. Consider the figure below:

\begin{figure}

{\centering \includegraphics[width=0.3\linewidth]{tikztopng-figure4} 

}

\caption{perpendicular lines}\label{fig:unnamed-chunk-13}
\end{figure}
...
With the \textcolor{red}{\em mid-ordinate rule}\index{mid-ordinate rule}, the curve for which we want to know the area is divided into strips of equal width \(s\).
...
For the \textcolor{red}{\em trapezium rule}\index{trapezium rule}, the curve is again divided into strips of equal width \(s\), but this time, the area of each strip is approximated by a trapezium instead of a rectangle.
...
The idea behind \textcolor{red}{\em Simpson's rule}\index{Simpson's rule} is that instead of approximating the curve using a series of trapeziums, we approximate by using a series of quadratic polynomials.
...
Consider the 2-dimensional strip below, and suppose that the \textcolor{red}{\em density}\index{density} at the point \(x\) is given by \(\rho(x)\).
